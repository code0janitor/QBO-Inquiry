package code.janitor.qbo.web.helper;

import static code.janitor.qbo.web.AppConstant.API_GATEWAY;
...
public class QBOServiceHelper {
	...
	public DataService getDataService(String realmId, String accessToken) throws FMSException {
    	...
    	String url = factory.getPropertyValue(API_GATEWAY) + "/v3/company";
		...
		logger.debug("Getting Data Service Configuration >>> " + context);
		
		// create dataservice
		DataService ds = new DataService(context);
		
		logger.debug("Data Service from Config >>> " + ds);
