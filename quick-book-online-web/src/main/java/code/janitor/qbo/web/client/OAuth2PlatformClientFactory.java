package code.janitor.qbo.web.client;
...
public class OAuth2PlatformClientFactory {
	...
	public void init() {
		...
		oauth2Config = new OAuth2Config.OAuth2ConfigBuilder(env.getProperty(CLIENT_ID),
				env.getProperty(CLIENT_SECRET)) //set client id, secret
